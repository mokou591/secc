...
<title>创建${mainBook.chsName}的评论</title>
		<style type="text/css">
			*{
				font-size: 16px;
			}
	...
	<div class="row clearfix">
		<div class="col-md-8 column">
			<div class="page-header">
				<h2>
					评价 <small>为书 ${mainBook.chsName} 作出评价</small>
				</h2>
			</div>
			<form role="form" action="${ctx}/book/review_submit" method="post">
				<input type="hidden" name="bookId" value="${mainBook.id }"  />
		...
		<div class="col-md-4 column">
			<div class="page-header">
				<h2>
					<a id="to_book" href="${ctx }/book/${mainBook.id}"> &gt; ${mainBook.chsName}</a>
				</h2>
			</div>
