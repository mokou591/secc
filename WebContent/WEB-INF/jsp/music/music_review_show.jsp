		...
		<div class="col-md-12 column">
			...
			<div class="row clearfix">
									...
									function(result){
										switch(result){
											...
											case "hasDone":
												...
												break;
											case "needToLogin":
												resultTip='登录后才能评价哦 <a class="btn btn-default btn-xs" href="${ctx}/user/login?loginPrevPage=/music/review/${review.id}">登录</a>';
												break;
											default:
										}
					...
					<div class="col-md-10 col-md-offset-2">
						...
						<c:choose>
							<c:when test="${empty loginUser}">
								<a href="${ctx}/user/login?loginPrevPage=/music/review/${review.id}" style="margin:50px 0;" class="btn btn-link"> &gt; 我来回应 </a>
							</c:when>
							...
							<c:otherwise>
								...
								<form action="${ctx}/music/review/${review.id}/reply_submit" method="post" role="form">
				...
				<div class="col-md-4 column">
					<div class="page-header">
						<a href="${ctx}/music/${review.music.id}/review_new" class="btn btn-primary">我要评价</a>
					</div>
					<div class="page-header">
						<h4>
