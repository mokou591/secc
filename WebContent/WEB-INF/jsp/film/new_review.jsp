...
<title>创建${mainFilm.chsName}的评论</title>
		<style type="text/css">
			*{
				font-size: 16px;
			}
	...
	<div class="row clearfix">
		<div class="col-md-8 column">
			<div class="page-header">
				<h2>
					评价 <small>为电影 ${mainFilm.chsName} 作出评价</small>
				</h2>
			</div>
			<form role="form" action="${ctx}/film/review_submit" method="post">
				<input type="hidden" name="filmId" value="${mainFilm.id }"  />
				...
				<div class="form-group">
					<label for="isSpoiler" >
						<input id="isSpoiler" type="checkbox" name="isSpoiler" > 有关键情节透露</input>
					</label>
				</div>
		...
		<div class="col-md-4 column">
			<div class="page-header">
				<h2>
					<a id="to_film" href="${ctx }/film/${mainFilm.id}"> &gt; ${mainFilm.chsName}</a>
				</h2>
			</div>
