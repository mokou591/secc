	...
	<div class="review">
		...
		<div class="review_ooxx">
			...
			<c:if test="${review.replyCount > 0}">
				<a href="${ctx}/book/review/${review.id}" class="btn btn-link">${review.replyCount}回应</a>
			</c:if>
				...
				function(result){
					switch(result){
						...
						case "hasDone":
							...
							break;
						case "needToLogin":
							resultTip='登录后才能评价哦 <a class="btn btn-default btn-xs" href="${ctx}/user/login?loginPrevPage=/book/${mainBook.id}">登录</a>';
							break;
						default:
					}
